    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_self_harm', models.IntegerField(db_column='Client_self_harm')),
                ('yls_PriorCurrentOffenses_Score', models.IntegerField(blank=True, db_column='YLS_PriorCurrentOffenses_Score')),
                ('yls_FamCircumstances_Score', models.IntegerField(blank=True, db_column='YLS_FamCircumstances_Score')),
                ('yls_Edu_Employ_Score', models.IntegerField(blank=True, db_column='YLS_Edu_Employ_Score')),
                ('yls_Peer_Score', models.IntegerField(blank=True, db_column='YLS_Peer_Score')),
                ('yls_Subab_Score', models.IntegerField(blank=True, db_column='YLS_Subab_Score')),
                ('yls_Leisure_Score', models.IntegerField(blank=True, db_column='YLS_Leisure_Score')),
                ('yls_Personality_Score', models.IntegerField(blank=True, db_column='YLS_Personality_Score')),
                ('yls_Attitude_Score', models.IntegerField(blank=True, db_column='YLS_Attitude_Score')),
                ('cans_LifeFunctioning', models.IntegerField(db_column='CANS_LifeFunctioning')),
                ('cans_YouthStrengths', models.IntegerField(db_column='CANS_YouthStrengths')),
                ('cans_CareGiverStrengths', models.IntegerField(db_column='CANS_CareGiverStrengths')),
                ('cans_Culture', models.IntegerField(db_column='CANS_Culture')),
                ...
                ('abuse_neglect', models.IntegerField(choices=[(0, 'no'), (1, 'yes')], db_column='abuse_neglect')),
