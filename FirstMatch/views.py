...
from rest_framework.generics import ListCreateAPIView, UpdateAPIView,RetrieveUpdateAPIView, ListAPIView, RetrieveUpdateDestroyAPIView
...
class AdminUpdate(RetrieveUpdateDestroyAPIView):
